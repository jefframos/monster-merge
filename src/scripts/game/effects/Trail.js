...
export default class Trail extends PIXI.Container{
	constructor(trailContainer, points = 30, texture = 'cat_head'){
		super();
		...
		let tempTexture = PIXI.Texture.from(texture)
		tempTexture.wrapMode =  PIXI.WRAP_MODES.REPEAT;
		this.mesh = new PIXI.mesh.Mesh(tempTexture, this.polyVerts, this.polyUvs, this.polyIndicies, PIXI.mesh.Mesh.DRAW_MODES.TRIANGLE_STRIP)
