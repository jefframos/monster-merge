...
export default class EffectLayer extends PIXI.Container{
	...
	fadeBloom(initValue = 0, endValue = 10, time = 0.5, delay = 0, removeAfter){
		this.addBloom();
	...
	shake(force, steps, time){
		...
		let speed = time / steps;
		for (var i = steps; i >= 0; i--) {
			timelinePosition.append(TweenLite.to(this.container.position, speed, {x: Math.random() * positionForce - positionForce/2, y: Math.random() * positionForce - positionForce/2, ease:"easeNoneLinear"}));
		};

		timelinePosition.append(TweenLite.to(this.container.position, speed, {x:0, y:0, ease:"easeeaseNoneLinear"}));		
	}
	...
	shakeX(force, steps, time){
		...
		let speed = time / steps;
		for (var i = steps; i >= 0; i--) {
			timelinePosition.append(TweenLite.to(this.container.position, speed, {x: Math.random() * positionForce - positionForce/2, ease:"easeNoneLinear"}));
		};
	...
	shakeY(force, steps, time){
		...
		let speed = time / steps;
		for (var i = steps; i >= 0; i--) {
			timelinePosition.append(TweenLite.to(this.container.position, speed, {y: Math.random() * positionForce - positionForce/2, ease:"easeNoneLinear"}));
		};
	...
	shakeRotation(force, steps, time){
		...
		let speed = time / steps;
		for (var i = steps; i >= 0; i--) {
			timelinePosition.append(TweenLite.to(this.container, speed, {rotation: Math.random() * rotationForce - rotationForce/2, ease:"easeNoneLinear"}));
		};

		timelinePosition.append(TweenLite.to(this.container, speed, {rotation: 0, ease:"easeeaseNoneLinear"}));		
	}
