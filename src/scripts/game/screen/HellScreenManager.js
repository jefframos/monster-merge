...
export default class HellCatsScreenManager extends ScreenManager {
    constructor() {
        super();
        ...
        this.partyScreen = new PartyScreen('PartyScreen');
        // this.addChild(screenManager);
        this.addScreen(this.partyScreen);
        ...
        this.gameScreen.onGameOver.add(() => {
            setTimeout(() => {
                this.change('PartyScreen');//this.showPopUp('init')
            }, 1000);
