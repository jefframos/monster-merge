...
export default class ScreenTransition extends PIXI.Container {
    constructor() {
        ...
        this.shapeCover1 = new PIXI.mesh.NineSlicePlane(
        ...
        this.tiledBackground = new PIXI.TilingSprite(PIXI.Texture.fromFrame('patter-square', 256, 256))
        ...
        this.logo = new PIXI.Sprite.fromFrame('logoTransparent')
