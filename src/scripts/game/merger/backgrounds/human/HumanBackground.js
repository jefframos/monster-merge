import HumanCastleBackground from "./HumanCastleBackground";
import InteractiveBackgrounds from "../InteractiveBackgrounds";
import PuzzleHumanBackground from "./PuzzleHumanBackground";

export default class HumanBackground extends InteractiveBackgrounds {
    constructor() {
        super();
