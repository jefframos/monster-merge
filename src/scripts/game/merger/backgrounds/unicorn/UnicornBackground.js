...
import PuzzleUnicornBackground from "./PuzzleUnicornBackground";
import UnicornCastleBackground from "./UnicornCastleBackground";

export default class UnicornBackground extends InteractiveBackgrounds {
    constructor() {
        super();
    ...
    build() {
        ...
        this.castleBackground = new UnicornCastleBackground();
        this.puzzleBackground = new PuzzleUnicornBackground();
